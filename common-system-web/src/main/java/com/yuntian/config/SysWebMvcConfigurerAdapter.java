...
import com.yuntian.sys.interceptor.SysLoginInterceptor;
 ...
 */
@Configuration
public class SysWebMvcConfigurerAdapter implements WebMvcConfigurer {
    ...
    @Bean
    SysLoginInterceptor backendLoginInterceptor() {
